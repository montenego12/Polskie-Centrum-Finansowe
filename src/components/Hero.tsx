...
export function Hero({ t, tForm, lang }: HeroProps) {
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(135deg,#0a0f1e_0%,#0d1b3e_50%,#0a1628_100%)] bg-[length:400%_400%] animate-gradientShift px-6 pt-10 pb-10 md:px-12 md:pt-14 md:pb-14 min-h-[80vh] flex items-start">
      {/* Orbs */}
